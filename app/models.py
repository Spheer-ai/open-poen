...
class Payment(db.Model, DefaultCRUD, DefaultErrorMessages):
    ...
    entry_reference = db.Column(db.String(128))
    end_to_end_id = db.Column(db.String(128))
    ...
    creditor_account = db.Column(db.String(128))
    debtor_name = db.Column(db.String(128))
    debtor_account = db.Column(db.String(128))
